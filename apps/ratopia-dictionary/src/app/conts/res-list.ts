...
const RES_META_COUNT: Partial<Record<Resources, number>> = {
  Armadillo: 5,
  Bat: 5,
  Bee: 5,
  BonePowder: 10,
...
export enum Resources {
  ...
  Frog = "Frog",
  FunnyFlower = "FunnyFlower",
  FunnyPollen = "FunnyPollen",
  GearWheel = "GearWheel",
  GlassBottle = "GlassBottle",
  Glasshandicraft = "Glasshandicraft",
  Glass = "Glass",
  GoldAccessory = "GoldAccessory",
  GoldIngot = "GoldIngot",
  Gold = "Gold",
  Grain = "Grain",
  Grass = 'Grass',
  GrainPowder = "GrainPowder",
  ...
  Rabbit = "Rabbit",
  RawMeat = "RawMeat",
  RegenerativePotion = "RegenerativePotion",
  Rock = "Rock",
  Rope = "Rope",
  Rubber = "Rubber",
  Sack = "Sack",
...
export const ALL_RES_LIST = Object.values(Resources);

export function getResourceIcon(resource: Resources): string {
